(function() {
    ...
    function addScrollerDivs() {
        ...
        sd2.style.cssText='position:relative;width:99%;overflow:hidden;overflow-x:hidden;padding:0px;margin:0px;';
        sd2.innerHTML='<div id="Scroller:fx" style="position:relative;width:auto;padding:0px;margin-left:0px;"><div id="Scroller:content"><font size="3" color="red">Please wait while loading the table..</font></div></div>';
